    ...
    module Template
      ...
      module Rghost
        ...
        def modelo_generico_cabecalho(doc, boleto)
          ...
          # LOGOTIPO do BANCO
          doc.image boleto.logotipo, x: '0.36 cm', y: '26.05 cm'
          # Dados
          doc.moveto x: '5.2 cm', y: '26.1 cm'
          doc.show "#{boleto.banco}-#{boleto.banco_dv}", tag: :grande
          doc.moveto x: '7.5 cm', y: '26.1 cm'
          doc.show boleto.codigo_barras.linha_digitavel, tag: :grande
          doc.moveto x: '0.7 cm', y: '25.2 cm'
          doc.show boleto.cedente
          doc.moveto x: '11 cm', y: '25.2 cm'
          doc.show boleto.agencia_conta_boleto
          doc.moveto x: '14.2 cm', y: '25.2 cm'
          doc.show boleto.especie
          doc.moveto x: '15.7 cm', y: '25.2 cm'
          doc.show boleto.quantidade
          doc.moveto x: '0.7 cm', y: '23.5 cm'
          doc.show boleto.numero_documento
          doc.moveto x: '7 cm', y: '23.5 cm'
          doc.show "#{boleto.documento_cedente.formata_documento}"
          doc.moveto x: '12 cm', y: '23.5 cm'
          doc.show boleto.data_vencimento.to_s_br
          doc.moveto x: '16.5 cm', y: '25.2 cm'
          doc.show boleto.nosso_numero_boleto
          doc.moveto x: '16.5 cm', y: '23.5 cm'
          doc.show boleto.valor_documento.to_currency
          doc.moveto x: '1.5 cm', y: '22.2 cm'
          doc.show "#{boleto.sacado} - #{boleto.sacado_documento.formata_documento}"
          doc.moveto x: '1.5 cm', y: '21.9 cm'
        ...
        def modelo_generico_rodape(doc, boleto)
          ...
          doc.moveto x: '16.5 cm', y: '13.5 cm', :align => :right
          doc.show boleto.valor_documento.to_currency
